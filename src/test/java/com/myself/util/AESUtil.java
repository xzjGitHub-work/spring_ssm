...
public class AESUtil {
    ...
    Logger logr = LoggerFactory.getLogger(AESUtil.class);
    /**
     * 加密
     * 1.构造密钥生成器
    ...
    public static void main(String[] args) {
        ...
        String s = aesDecode("6x9mfxP8HvsL/Y93pKzu4A==");
        /*for (String key : keys) {
            log.warn(key + " | ");
            String encryptString = aesEncode(key);
            log.warn("加密:" + encryptString);
            String decryptString = aesDecode(encryptString);
            log.warn("解密" + decryptString);
        }*/
    }
